                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                            {timelineData.map((item, i) => (
                                <div key={i} className="group relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                    ...
                                    <div className="w-full bg-white rounded-2xl p-5 border border-gray-100 shadow-sm transition-all duration-400 group-hover:shadow-xl group-hover:-translate-y-1 group-hover:border-accent/20 relative overflow-hidden">
